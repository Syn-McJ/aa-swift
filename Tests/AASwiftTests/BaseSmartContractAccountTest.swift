...
final class BaseSmartContractAccountTest {
    ...
    @Test("encodeGetSenderAddress returns correct hex")
    func encodeGetSenderAddressReturnsCorrectHex() async throws {
        ...
        #expect(
            encoded.lowercased() == "".lowercased()
        )
    }
}
