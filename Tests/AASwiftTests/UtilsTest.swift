...
struct UtilsTest {
    ...
    @Test("getUserOperationHash returns correct hash")
    func getUserOperationHashReturnsCorrectHash() throws {
        ...
        #expect(hash.lowercased() == "0xa70d0af2ebb03a44dcd0714a8724f622e3ab876d0aa312f0ee04823285d6fb1b".lowercased())
    }
    
    @Test("toUserOperationRequest returns correct request")
    func toUserOperationRequestReturnsCorrectRequest() throws {
        let request = uoStruct.toUserOperationRequest()
        #expect(request == uoRequest)
    }
    
    @Test("packAccountGasLimits works correctly")
    ...
    @Test("packPaymasterData works correctly")
    ...
    @Test("packPaymasterData returns empty when paymasterData is nil")
    func packPaymasterDataReturnsEmptyWhenPaymasterDataIsNil() throws {
        let packed = packPaymasterData(
    ...
    @Test("getUserOperationHash v0.7.0 returns correct hash")
    func getUserOperationHashV070ReturnsCorrectHash() throws {
